...
- 升级MySQL驱动文件到8.4.0版本
- 适配达梦8 -2026.01.23
- 批量插入插件更新：1.字段有默认值：属性为null → 用默认值；属性非null → 正常传值; 2.字段无默认值：根据字段具体内容传值  -2026.03.20
- 批量插入插件更新：可根据具体配置，返回主键id -2026.04.23
- 达梦8模糊查询适配 -2026.05.07
- TinyInt默认转换成Integer，取消自定义选项 -2026.08.04
- 解决达梦8跨库问题 -2026.08.05
